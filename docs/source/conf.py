...
import os
import sys
sys.path.insert(0, os.path.abspath('../../pvpumpingsystem/'))
sys.path.insert(0, os.path.abspath('../../'))


# -- Project information -----------------------------------------------------

project = 'pvpumpingsystem'
copyright = '2020, Tanguy Lunel'
author = 'Tanguy Lunel'
...
# a list of builtin themes. 'alabaster' and 'sphinx_rtd_theme' are 2 options.
#
